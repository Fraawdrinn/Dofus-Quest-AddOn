...
class MainWindow(QMainWindow):
  ...
  def create_main_menu(self) -> QWidget:
    ...
    # Navigation buttons
    search_button = QPushButton("Search for a quest")
    search_button.clicked.connect(lambda: self.switch_menu("search"))
    # Add style
    search_button.setStyleSheet("color: black; background-color: gray;")
    ...
    # Add style
    about_button.setStyleSheet("color: black; background-color: gray; font-size: 8px; border: none;")
    about_button.setFixedSize(100, 10)

    layout.addWidget(search_button, alignment=Qt.AlignTop)
